 ...
 * Stub hash: cdfe6bf9ce510c6a83b4e5d7a6dc3cce14269290 */
...
static zend_class_entry *register_class_MdParser_Options(void)
{
	...
	zend_string *property_noIndentedCodeBlocks_name = zend_string_init("noIndentedCodeBlocks", sizeof("noIndentedCodeBlocks") - 1, 1);
	...
	zend_string_release(property_noIndentedCodeBlocks_name);

	zval property_permissiveAtxHeadings_default_value;
	ZVAL_UNDEF(&property_permissiveAtxHeadings_default_value);
	zend_string *property_permissiveAtxHeadings_name = zend_string_init("permissiveAtxHeadings", sizeof("permissiveAtxHeadings") - 1, 1);
	...
	zend_string_release(property_permissiveAtxHeadings_name);

	zval property_collapseWhitespace_default_value;
	ZVAL_UNDEF(&property_collapseWhitespace_default_value);
	zend_string *property_collapseWhitespace_name = zend_string_init("collapseWhitespace", sizeof("collapseWhitespace") - 1, 1);
	...
	zend_string_release(property_collapseWhitespace_name);

	zval property_underline_default_value;
	ZVAL_UNDEF(&property_underline_default_value);
	zend_string *property_underline_name = zend_string_init("underline", sizeof("underline") - 1, 1);
	...
	zend_string_release(property_underline_name);

	zval property_highlight_default_value;
	ZVAL_UNDEF(&property_highlight_default_value);
	zend_string *property_highlight_name = zend_string_init("highlight", sizeof("highlight") - 1, 1);
	...
	zend_string_release(property_highlight_name);

	zval property_superscript_default_value;
	ZVAL_UNDEF(&property_superscript_default_value);
	zend_string *property_superscript_name = zend_string_init("superscript", sizeof("superscript") - 1, 1);
	...
	zend_string_release(property_superscript_name);

	zval property_subscript_default_value;
	ZVAL_UNDEF(&property_subscript_default_value);
	zend_string *property_subscript_name = zend_string_init("subscript", sizeof("subscript") - 1, 1);
	...
	zend_string_release(property_subscript_name);

	zval property_spoilers_default_value;
	ZVAL_UNDEF(&property_spoilers_default_value);
	zend_string *property_spoilers_name = zend_string_init("spoilers", sizeof("spoilers") - 1, 1);
	...
	zend_string_release(property_spoilers_name);

	zval property_latexMath_default_value;
	ZVAL_UNDEF(&property_latexMath_default_value);
	zend_string *property_latexMath_name = zend_string_init("latexMath", sizeof("latexMath") - 1, 1);
	...
	zend_string_release(property_latexMath_name);

	zval property_wikiLinks_default_value;
	ZVAL_UNDEF(&property_wikiLinks_default_value);
	zend_string *property_wikiLinks_name = zend_string_init("wikiLinks", sizeof("wikiLinks") - 1, 1);
	...
	zend_string_release(property_wikiLinks_name);

	zval property_admonitions_default_value;
	ZVAL_UNDEF(&property_admonitions_default_value);
	zend_string *property_admonitions_name = zend_string_init("admonitions", sizeof("admonitions") - 1, 1);
	...
	zend_string_release(property_admonitions_name);
